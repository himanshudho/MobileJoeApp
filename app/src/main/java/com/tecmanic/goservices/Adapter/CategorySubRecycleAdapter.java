...
import static com.tecmanic.goservices.ServicesListActivity.bottom_linearr;
import static com.tecmanic.goservices.ServicesListActivity.check;
import static com.tecmanic.goservices.ServicesListActivity.tv_items;
import static com.tecmanic.goservices.ServicesListActivity.tv_price;


public class CategorySubRecycleAdapter extends RecyclerView.Adapter<CategorySubRecycleAdapter.MyViewHolder> {

    Context context;
    private List<ChildServiceModelClss> OfferList;
    private int count = 1;
    String  ratingid;
    String user_id;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
     ...
     /*   if (dbcart.isInCart(lists.getService_id())) {
        ...
        holder.l1_rating.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
