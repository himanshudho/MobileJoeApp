...
import com.tecmanic.goservices.Adapter.HomeCategoryHorizontalRecycleAdapter;
import com.tecmanic.goservices.Adapter.SubCategoryAdapter;
...
import static com.tecmanic.goservices.Extra.Config.HomeSubCategory;
...
//        tabLayout.getTabAt(tab_value);
       ...
       /* if(!cateId.isEmpty()){
            //  tabLayout.getTabAt(tabLayout.setScrollPosition(cateId);
            tabLayout.getChildAt(Integer.parseInt(cateId));
        }*/
                        ...
                        if (status.contains("1")) {
                            ...
                            if (!menu_models.isEmpty()) {
                                ...
                                for (int i = 0; i < menu_models.size(); i++) {
                                    ...
                                    tabLayout.addTab(tabLayout.newTab().setText(menu_models.get(i).getCategory_name()));
                                }
                            }
                        }
                        else {}
