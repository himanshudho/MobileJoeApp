...
import com.tecmanic.goservices.Adapter.Add_on_adapter;
...
import static com.tecmanic.goservices.Extra.Config.add_on;
...
public class Add_on_Activity extends AppCompatActivity {
    ...
    childid=getIntent().getStringExtra("child_category_id");
       ...
       /* titleNot.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                titleNot.setChecked(true);
                cat_id_json_array.put("0");
            }else {
                    titleNot.setChecked(false);
                }
            }
        });*/
        add_on();
