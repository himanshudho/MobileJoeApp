...
import com.tecmanic.goservices.Adapter.Timing_Adapter;
import com.tecmanic.goservices.Extra.CustomVolleyJsonRequest;
import com.tecmanic.goservices.ModelClass.timing_model;
import at.grabner.circleprogress.CircleProgressView;
import devs.mulham.horizontalcalendar.HorizontalCalendar;
import devs.mulham.horizontalcalendar.utils.HorizontalCalendarListener;

import static com.tecmanic.goservices.Extra.Config.SplitTime;
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof TimeoutError || error instanceof NoConnectionError) {
                    if (Delivery_date_time.this != null) {
                        progressDialog.dismiss();
                     //   Toast.makeText(Delivery_date_time.this, getResources().getString(R.string.connection_time_out), Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
