...
public class PayPal extends AppCompatActivity {
    ...
    private void getPayment() {
        ...
        PayPalPayment payment = new PayPalPayment(new BigDecimal(amount), "INR", "Coding Fee",
