...
import com.tecmanic.goservices.Adapter.ProfileRecycleAdapter;
...
import com.tecmanic.goservices.AboutUsActivity;
import com.tecmanic.goservices.EditProfileActivity;
import com.tecmanic.goservices.Extra.Config;
import com.tecmanic.goservices.FAQmain_Activity;
import com.tecmanic.goservices.Manage_address;
import com.tecmanic.goservices.NotificationActivity;
import com.tecmanic.goservices.R;
import com.tecmanic.goservices.TermsConditionActivity;
...
*/
    ...
    CustomVolleyJsonRequest jsonObjReq = new CustomVolleyJsonRequest(Request.Method.POST,
        ...
        public void onResponse(JSONObject response) {
           ...
           /*       *//*  Glide.with(getContext()).load(IMAGE_URL+user_image).apply(RequestOptions.skipMemoryCacheOf(true))
