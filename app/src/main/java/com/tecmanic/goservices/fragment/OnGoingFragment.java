...
import com.tecmanic.goservices.Adapter.BookingOnGoingAdapter;

import com.tecmanic.goservices.Extra.CustomVolleyJsonRequest;
import com.tecmanic.goservices.Extra.Session_management;
import com.tecmanic.goservices.ModelClass.OnGoingBookingModelClass;
...
public class OnGoingFragment extends Fragment {
    ...
    private void hitOngoingUrl(String userID) {
        ...
        /*CustomVolleyJsonArrayRequest jsonObjReq = new CustomVolleyJsonArrayRequest(Request.Method.POST,
                bookingonGOING, params, new Response.Listener<JSONArray>() {
            @Override
                ...
                progressDialog.dismiss();
                    ...
                    if (response != null && response.length() > 0) {
                        ...
                        Gson gson = new Gson();
                            ...
                            onGoingBookingModelClasses = gson.fromJson(response.toString(), listType);
